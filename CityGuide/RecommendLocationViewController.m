//
//  RecommendLocationViewController.m
//  CityGuide
//
...
#import "RecommendLocationViewController.h"
#import "VenueCell.h"
#import <RestKit/RestKit.h>

#define kCLIENTID "TZM5LRSRF1QKX1M2PK13SLZXRXITT2GNMB1NN34ZE3PVTJKT"
#define kCLIENTSECRET "250PUUO4N5P0ARWUJTN2KHSW5L31ZGFDITAUNFWVB5Q4WJWY"

@interface RecommendLocationViewController ()

@property (nonatomic, strong) NSArray *venues;

@end

@implementation RecommendLocationViewController
...
{
    VenueCell *cell = [self.tView dequeueReusableCellWithIdentifier:@"VenueCell" forIndexPath:indexPath];
...
- (void)loadVenues
{
    NSString *latLon = @"53.38,-1.46"; // approximate latLon of The Mothership
    NSString *clientID = [NSString stringWithUTF8String:kCLIENTID];
    NSString *clientSecret = [NSString stringWithUTF8String:kCLIENTSECRET];
    
    NSDictionary *queryParams;
    queryParams = [NSDictionary dictionaryWithObjectsAndKeys:latLon, @"ll", clientID, @"client_id", clientSecret, @"client_secret", @"4d4b7105d754a06372d81259", @"categoryId", @"20140118", @"v", nil];
